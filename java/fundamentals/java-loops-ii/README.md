...
query, print the series corresponding to the given *a*,*b*, and *n*
...
separated integers describing the respective *ai, bi, and ni* values for that query.
...
One we hit *n = 10*, we print the first ten terms as a single line of space-separated integers.
